<div class="popup center modal_show">
    ...
    <form method="post" name="formValidation" id="formValidation" action="../vendor/create.php">
        <div class="profession required">
            <label class="radio-inline"><input type="radio" name="profession" class="form-contorl" value="student"/>Student</label>
            <label class="radio-inline"><input type="radio" name="profession" class="form-contorl" value="parent"/>Parent</label>
            <label class="radio-inline"><input type="radio" name="profession" class="form-contorl" value="counselor"/>Counselor</label>
            <label class="radio-inline"><input type="radio" name="profession" class="form-contorl" value="other"/>Other</label>
        </div>
