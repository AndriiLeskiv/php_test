...
<form method="POST" name="formValidation" id="formValidation" action="vendor/update.php">
    ...
    <div class="profession required">
        <label class="radio-inline"><input type="radio" name="profession" value="student" class="form-contorl"/>Student</label>
        <label class="radio-inline"><input type="radio" name="profession" value="parent" class="form-contorl"/>Parent</label>
        <label class="radio-inline"><input type="radio" name="profession" value="counselor" class="form-contorl"/>Counselor</label>
        <label class="radio-inline"><input type="radio" name="profession" value="other" class="form-contorl"/>Other</label>
    </div>
    ...
    <select class = "form-control form-control-lg required" name="currentgrade"  value="<?=$info['currentgrade']?>">
        <option value="Current Grade/Year in School">Current Grade/Year in School</option>
    ...
    <select class = "form-control form-control-lg" name = "online_search" value="<?= $info['online_search']?>">
        <option value="Online_search1">Online search1</option>
