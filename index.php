...
<nav class="navbar navbar-inverse navbar-fixed-top  container-fluid p-0 m-0">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">Scholarships<span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="#">Scholarships 1-1</a></li>
                        <li><a href="#">Scholarships 1-2</a></li>
                        <li><a href="#">Scholarships 1-3</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">Free Guides<span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="#">Free Guides 1-1</a></li>
                        <li><a href="#">Free Guides 1-2</a></li>
                        <li><a href="#">Free Guides 1-3</a></li>
                    </ul>
                </li>
                <li><a href="#">Blog</a></li>
...
<main role="main" class="main_content">
    <div class="jumbotron jumbotron-fluid m-0">
        <div class="container p-0" style="display: flex; justify-content: space-between; align-items: center;">
            <div class="dropdown">
                <button class="btn dropdown-toggle" type="button" data-toggle="dropdown">Type of Student
            ...
            <form style="display: flex">
                <input type="email"  class="form-control-lg p-2" placeholder="New York" style="width: 637px">
                <input type="submit" class="btn-danger form-control-lg" value="Subscribe" style="width: 30%" >
            </form>
            <div class="dropdown">
                <button class="btn dropdown-toggle" type="button" data-toggle="dropdown">
                    <img src="static/img/filter.svg" alt="filter" style="margin-right: 10px;">Filter By
...
<div class="containers">
    <p class="count">Showing 1 to 5 of 22 results</p>
    <div class="item-box">
        <div class="item show_form_validation">
            <div class="img-box">
                <p>Amount Varies</p>
            </div>
            <div class="text">
                <h4>New York Financial Writers' Associations Scholarships</h4>
                <h5>New York Financial Writers Association</h5>
                <p><span>Amount:</span> Varies</p>
                <p><span>Deadline:</span> 4/15</p>
            </div>
            <div class="save-box">
                <div>
        ...
        <div class="item show_form_validation">
            <div class="img-box">
                <p></p>
                <img src="static/img/money.png" alt="money">
            </div>
            <div class="text">
                <h4>New York Financial Writers' Associations Scholarships</h4>
                <h5>New York Financial Writers Association</h5>
...
<div class="popup center modal_show">
    ...
    <form method="POST" name="formValidation" id="formValidation" action="create.php">
        ...
        <br/>
        <input type="text" id="datepicker" class="form-control form-control-lg required" name="data" placeholder="Data">
        <br/>
        <!--        <div>-->
        <!--            SUBSCRIBE:-->
        <!--        </div>-->
        ...
        <!--        <div class = "hobbies">-->
        <!--            <label class="checkbox-inline"><input type="checkbox" name = "hobbies">-->

        <!--                <div>-->
        <!--                    <label class="checkbox-inline"><input type="checkbox" name = "hobbies">-->
        <!--                        <h3>Scholarship Plus</h3>-->
        <!--                        <span>A weekly newsletter with scholarship updates and news.</span>-->
        <!--                    </label>-->
        <!--                </div>-->
        <!--            </label>-->
        <!--        </div>-->
                ...
                <div class="row" >
                    <div class="col-6">
                        <ul class="list-unstyled">
                            <li><a href="#">College Admission</a></li>
                            <li><a href="#">Financial Aid</a></li>
                            <li><a href="#">Campos Life</a></li>
                            <li><a href="#" class="last_list">Scholarship Search</a></li>
                        </ul>
                    </div>
                </div>
                <ul class="nav" style="display: flex">
                    <li class="nav-item"><a href="#" class="nav-link pl-0"><img src="static/img/facebook.png" alt="logo" style="width: 30px"></a></li>
                    <li class="nav-item"><a href="#" class="nav-link"><img src="static/img/pinterest.png" alt="logo" style="width: 30px"></a></li>
                    <li class="nav-item"><a href="#" class="nav-link"><img src="static/img/twitter.png" alt="logo" style="width: 30px"></a></li>
                </ul>
                <br>
            </div>
            <div class="col-md-6" style="border-left: 2px solid black">
                <p class="footer_description">
                    A weekly newsletter to show you how to apply to college and pay for it like a boss. Already in college?
                    You`ll get good stuff to help with selecting a major, study tips, side hustle and more
                </p>
                <form>
                    <fieldset class="form-group">
                        <input type="email"  id="exampleInputEmail1" class="form-control-lg mr-2 p-2" placeholder="Your email address">
                        <input type="submit" class="btn-danger form-control-lg " value="SUBSCRIBE" style="width: 30%;" >
                    </fieldset>
                </form>
            </div>
